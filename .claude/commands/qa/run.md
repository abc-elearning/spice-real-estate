...
- `.claude/scripts/qa/axe-wrapper.sh` — `axe_screenshot`, `axe_describe_ui`, `axe_tap`, `axe_tap_id`, `axe_type`, `axe_swipe`, `axe_batch`
- `.claude/scripts/qa/simctl-wrapper.sh` — `simctl_auto_detect`, `simctl_list_booted`
- `.claude/scripts/qa/evidence-capture.sh` — `capture_step_evidence`, `capture_before_after`
...
```bash
source .claude/scripts/qa/diff-detect.sh
...
```bash
source .claude/scripts/qa/simctl-wrapper.sh
simctl_auto_detect
```
...
```bash
source .claude/scripts/qa/axe-wrapper.sh
...
1. **Source wrappers:**
   ```bash
   source .claude/scripts/qa/evidence-capture.sh
   ```
